...
////////////////////LOG E CAIXA////////////////////////
    ...
    begin
        ...
        with GRAVA_LOG do
        begin
          Parameters.ParamByName('@DESCRICAO').Value := 'Parcela nº ' + Edit1.Text + ' paga inteiramente.' ;
    ...
    begin
        ...
        with GRAVA_LOG do
        begin
          Parameters.ParamByName('@DESCRICAO').Value := 'Parcela nº ' + Edit1.Text + ' paga parcialmente.' ;
          Parameters.ParamByName('@USUARIO').Value := Unit_TELA_PRINCIPAL.Form_TELA_PRINCIPAL.QUERY_USUARIOCOD_USUARIO.AsInteger;
          Parameters.ParamByName('@DTHORA').Value := ano_c + '-' + mes_c + '-' + dia_c + ' ' + hora_c;
          ExecProc;
        end;
...
begin
  ...
  if QUERY_PARCELASTATUS_PARCELA.AsBoolean = true then
  begin
    Application.MessageBox('Já está paga!', 'Atenção!', MB_ICONWARNING);
    EXIT;
  end
  else if QUERY_PARCELASTATUS_PARCELA.AsBoolean = false then
  begin
