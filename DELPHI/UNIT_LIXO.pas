...
begin
  ...
  begin
    Application.MessageBox('Login e/ou senha incorreto(s)! Atenção: você deve ser usuário administrador!', ' ', MB_ICONWARNING);
    Edit1.Clear;
    Edit2.Clear;
    Edit1.SetFocus;
  end
  ...
  begin
    ...
    begin
      Application.MessageBox('Usuário inválido. Você deve ser administrador!', 'Atenção!', MB_ICONWARNING);
      Edit1.Clear;
      Edit2.Clear;
    end;
    ...
    begin
              ...
              begin
                  Application.MessageBox('Recuperação concluída! As informações de usuários se encontram no local escolhido com o nome "RECUPERAÇÃO_DE_SENHA".', 'Atenção!', MB_ICONEXCLAMATION);
                  Texto.Add(Linha);
                  Texto.SaveToFile(s + '\RECUPERAÇÃO_DE_SENHA.txt');
                  Edit1.Clear;
                  Edit2.Clear;
              end;
    end;
