...
begin
  ...
  BEGIN
    Application.MessageBox('Escolha se houve pré agendamento!', 'Atenção!', MB_ICONWARNING);
    RadioGroup2.SetFocus;
    Exit;
  END;
  ...
  begin
    Application.MessageBox('Selecione o tratamento!', 'Atenção!', MB_ICONWARNING);
  ...
  begin
    Application.MessageBox('Selecione o pré-agendamento dessa consulta!', 'Atenção!', MB_ICONWARNING);
    RadioGroup2.SetFocus;
    Exit;
  end;
 ...
 begin
  ...
  begin
    Application.MessageBox('Já existe uma consulta para esse horário', 'ATENÇÃO!', MB_ICONERROR);
    MaskEdit2.Clear;
    MaskEdit2.SetFocus;
    exit;
  end;
