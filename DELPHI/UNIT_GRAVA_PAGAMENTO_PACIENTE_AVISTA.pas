...
begin
  ...
  begin
    Application.MessageBox('Preencha a data do pagamento!', 'Atenção!', MB_ICONWARNING);
    MaskEdit1.SetFocus;
    Exit;
  end;
  ...
  begin
    Application.MessageBox('Selecione o tipo de pagamento!', 'Atenção!', MB_ICONWARNING);
    Exit;
  end;

  if (RadioGroup2.ItemIndex=3)and(Edit2.Text='') then
  begin
    Application.MessageBox('Se o tipo de pagamento for "OUTROS" você deve preencher o campo "OUTROS"!', 'Atenção!', MB_ICONWARNING);
    Edit2.SetFocus;
    Exit;
  end;
  ...
  begin
    Application.MessageBox('Digite o valor do pagamento a vista!', 'Atenção!', MB_ICONWARNING);
    Edit1.SetFocus;
    Exit;
  end;
  ...
  begin
    GRAVA_PAGAMENTO_AVISTA.Parameters.ParamByName('@TIPO').Value := 'CARTÃO';
  end;
  ...
  begin
    GRAVA_PAGAMENTO_AVISTA.ExecProc;
        ...
        with GRAVA_LOG do
        begin
          Parameters.ParamByName('@DESCRICAO').Value := 'Pagamento à vista nº ' + INTTOSTR(GRAVA_PAGAMENTO_AVISTA.Parameters.ParamByName('@RETURN_VALUE').Value) + ' cadastrado.' ;
...
begin
    ...
    Application.MessageBox('Aqui você pode selecionar o dentista que receberá o pagamento!', 'Atenção!', MB_ICONINFORMATION);
...
begin
    ...
    Application.MessageBox('Aqui você pode selecionar a forma que será efetuado o pagamento! Caso seja "OUTROS", clique na opção "OUTROS" e preencha o campo que abrirá!',
...
begin
    ...
    Application.MessageBox('Aqui você pode selecionar o paciente que pagará!', 'Atenção!', MB_ICONINFORMATION);
