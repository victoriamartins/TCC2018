...
begin
  ...
  begin
    Application.MessageBox('Preencha o campo de preço unitário!', 'Atenção!', MB_ICONWARNING);
    Edit2.SetFocus;
    Exit;
  end;
  ...
  begin
    Application.MessageBox('Preencha o campo de Pago em:!', 'Atenção!', MB_ICONWARNING);
    Edit2.SetFocus;
    Exit;
  end;
  ...
  begin
    Application.MessageBox('Escolha o tipo do produto!', 'Atenção!', MB_ICONWARNING);
    ComboBox1.SetFocus;
    Exit;
  end;
  ...
  begin
    Application.MessageBox('Se o tipo for "OUTROS", preencha o campo de "OUTROS"!', 'Atenção!', MB_ICONWARNING);
    Edit5.SetFocus;
    Exit;
  end;
   ...
   begin
     GRAVA_PRODUTO.Parameters.ParamByName('@TIPO').Value := 'ANESTÉSICO';
     GRAVA_DESPESA.Parameters.ParamByName('@TIPO').Value := 'ANESTÉSICO';
   end
   ...
   begin
     GRAVA_PRODUTO.Parameters.ParamByName('@TIPO').Value := 'DESCARTÁVEIS';
     GRAVA_DESPESA.Parameters.ParamByName('@TIPO').Value := 'DESCARTÁVEIS';
   end
   ...
   begin
    ...
    with GRAVA_LOG do
    begin
      Parameters.ParamByName('@DESCRICAO').Value := 'Produto Nº ' + INTtOSTR(GRAVA_PRODUTO.Parameters.ParamByName('@RETURN_VALUE').Value) + ' cadastrado.' ;
    ...
    with GRAVA_LOG do
    begin
      Parameters.ParamByName('@DESCRICAO').Value := 'Despesa Nº ' + INTtOSTR(GRAVA_DESPESA.Parameters.ParamByName('@RETURN_VALUE').Value) + ' cadastrado.' ;
      Parameters.ParamByName('@USUARIO').Value := Unit_TELA_PRINCIPAL.Form_TELA_PRINCIPAL.QUERY_USUARIOCOD_USUARIO.AsInteger;
      Parameters.ParamByName('@DTHORA').Value := ano_c + '-' + mes_c + '-' + dia_c + ' ' + hora_c;
      ExecProc;
    end;
...
begin
  ...
  begin
    Application.MessageBox('Escolha o tipo de despesa!', 'Atenção!', MB_ICONWARNING);
    ComboBox2.SetFocus;
    Exit;
  end;
  ...
  if Edit4.Text='' then
  begin
    Application.MessageBox('Preencha o valor da despesa!', 'Atenção!', MB_ICONWARNING);
    Edit4.SetFocus;
    Exit;
  end;
  ...
  begin
    Application.MessageBox('Preencha a data de pagamento da despesa!', 'Atenção!', MB_ICONWARNING);
    MaskEdit2.SetFocus;
    Exit;
  end;
  ...
  begin
    Edit7.Visible := false;
    Label15.Visible := false;
    GRAVA_DESPESA.Parameters.ParamByName('@TIPO').Value := 'ÁGUA' ;
  end
...
begin
  ...
  Application.MessageBox('Aqui você pode cadastrar os produtos comprados. É uma forma de visualizar os gastos da empresa!', 'Atenção!', MB_ICONEXCLAMATION);
