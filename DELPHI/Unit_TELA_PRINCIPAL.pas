...
begin
      ...
      begin
        LBL_TIPO.Caption := 'USUÁRIO COMUM';
      ...
      begin
        LBL_TIPO.Caption := 'USUÁRIO ADMINISTRADOR';
          Image4.Visible := true;
          //Image5.Visible := true;
          Image2.Visible := true;
          //Image3.Visible := true;
...
begin
  ...
  if Application.MessageBox('Tem certeza que deseja fechar a tela principal?','ATENÇÃO!', mb_iconquestion + mb_yesno) = idYes then
  begin
...
TrayIcon1.BalloonHint:='O sistema está sendo executado em segundo plano, clique para voltar.';
...
begin
     ...
     begin
          Application.MessageBox('Não há nenhum agendamento registrado!','ATENÇÃO!',MB_ICONEXCLAMATION);
          exit;
     end;
