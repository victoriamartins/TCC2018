...
begin
  ...
  begin
    Application.MessageBox('Selecione o status!', 'Atenção!', MB_ICONERROR);
  ...
  begin
    ...
    GRAVA_PAG_DENTISTA.ExecProc;
                ...
                with GRAVA_LOG do
                begin
                  Parameters.ParamByName('@DESCRICAO').Value := 'Pag. dentista nº ' + INTTOSTR(GRAVA_PAG_DENTISTA.Parameters.ParamByName('@RETURN_VALUE').Value) + ' cadastrado.' ;
