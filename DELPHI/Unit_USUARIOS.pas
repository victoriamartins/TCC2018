...
begin
    ...
    begin
          ...
          if RadioGroup2.ItemIndex=4 then //Usuários comuns
          begin
                      if RadioGroup1.ItemIndex = 0 then
                      begin
                          ADOQuery1.close;
...
begin
    ...
    if ADOQuery1NOME_USUARIO.AsString = 'U_FÁBRICA' then
    begin
        Application.MessageBox('Não é possível alterar um usuário de fábrica', 'Atenção!', MB_ICONWARNING)
    end
    else
    begin
        Panel1.Left := 400;
        ...
        //Application.MessageBox('Confirme a senha do usuário a ser consultado!', 'Atenção!', MB_ICONEXCLAMATION);
...
begin
    ...
    begin
        Application.MessageBox('Preencha o campo do login!', 'Atenção!', MB_ICONWARNING);
        Edit3.SetFocus;
        Exit;
    end
    ...
    begin
        Application.MessageBox('Preencha o campo da senha!', 'Atenção!', MB_ICONWARNING);
        Edit4.SetFocus;
        Exit;
    end
    ...
    begin
        ...
        begin
            Application.MessageBox('Selecione um dentista na tabela de dentistas ou um funcionário na tabela de funcionários!', 'Atenção!', MB_ICONWARNING);
            Exit;
        end
        ...
        begin
            Application.MessageBox('Preencha o campo do tipo do usuário!', 'Atenção!', MB_ICONWARNING);
        end;
    end
    ...
    if Application.MessageBox('Tem certeza que deseja alterar o usuário?', 'ALTERAR', MB_ICONQUESTION + MB_YESNO) = IDYES then
    begin
    ...
    with GRAVA_LOG do
    begin
      Parameters.ParamByName('@DESCRICAO').Value := 'Usuário Nº ' + Edit1.Text + ' alterado.' ;
      ...
      ExecProc;
        ...
        Application.MessageBox('Usuário alterado!', 'AVISO', MB_OK)
    end
...
begin
    ...
    begin
        Application.MessageBox('Usuário confirmado com sucesso!', 'Atenção!', MB_ICONINFORMATION);
    ...
    begin
        Application.MessageBox('Senha incorreta!', 'Atenção!', MB_ICONERROR);
        Edit7.Clear;
        Edit7.SetFocus;
    end;
