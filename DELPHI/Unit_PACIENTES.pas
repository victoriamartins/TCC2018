...
begin
    ...
    begin
      Label19.Caption := 'NÃO POSSUI CPF!';
...
begin
  ...
  hora_c := Copy(lbl_data.Caption,14,8);
    ...
    if Application.MessageBox('Deseja alterar o paciente?','ATENÇÃO',MB_YESNO+MB_ICONQUESTION) = IDYES then
    BEGIN
          ...
          with GRAVA_LOG do
          begin
            Parameters.ParamByName('@DESCRICAO').Value := 'Paciente nº ' + Edit1.Text + ' alterado.' ;
