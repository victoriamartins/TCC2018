...
procedure TForm_CONSULTA_DENTISTA.DBGrid1DrawColumnCell(Sender: TObject;
...
procedure TForm_CONSULTA_DENTISTA.FormClose(Sender: TObject;
...
begin
    ...
    begin
        Application.MessageBox('Selecione um dentista!','ATENÇÃO!',MB_ICONEXCLAMATION);
        exit;
    end;
...
begin
    ...
    begin
        Application.MessageBox('Preencha o campo do CRO!', 'Atenção!', MB_ICONWARNING);
        Edit3.SetFocus;
        Exit;
    end
...
if Application.MessageBox('Tem certeza que deseja alterar o dentista?', 'ALTERAR', MB_ICONQUESTION + MB_YESNO) = IDYES then
  ...
  hora_c := Copy(lbl_data.Caption,14,8);
    ...
    with GRAVA_LOG do
    begin
      Parameters.ParamByName('@DESCRICAO').Value := 'Dentista nº ' + Edit1.Text + ' alterado.' ;
