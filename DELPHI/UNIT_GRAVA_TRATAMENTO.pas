...
begin
  if Edit1.Text='' then
  begin
    Application.MessageBox('Preencha o campo com nome do tratamento', 'Atenção!', MB_ICONWARNING);
    Edit1.SetFocus;
    Exit;
  end;
...
if Edit1.Text='' then
  ...
  begin
    ...
    with GRAVA_LOG do
    begin
      Parameters.ParamByName('@DESCRICAO').Value := 'Tratamento ' + Edit1.Text + ', código nº ' + INTtOSTR(GRAVA_TRATAMENTO.Parameters.ParamByName('@RETURN_VALUE').Value) + ' cadastrado.' ;
