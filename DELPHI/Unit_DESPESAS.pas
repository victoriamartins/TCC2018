...
begin
   ...
   begin
     Edit3.Visible := false;
     Label12.Caption := 'NÃO SE REFERE A PRODUTOS';
     Edit3.Clear;
   end;
   ...
   else if ADOQuery1TIPO_DESPESA.AsString = 'ÁGUA' then
   begin
...
begin
    ...
    Label1.Visible := TRUE;
    Label12.Visible := TRUE;
    if Label12.Caption = 'NÃO SE REFERE A PRODUTOS' then
    begin
...
begin
  ...
  begin
    Application.MessageBox('Não é possível excluir uma despesa que está vinculada a um produto!', 'Atenção!', MB_ICONMASK);
  end
  ...
  begin
    ...
    hora_c := Copy(lbl_data.Caption,14,8);
      ...
      begin
        ...
        Application.MessageBox('Despesa excluída!', 'EXCLUIR', MB_ICONEXCLAMATION);
        ...
        with GRAVA_LOG do
        begin
          Parameters.ParamByName('@DESCRICAO').Value := 'Despesa excluída.' ;
...
begin
{
    ...
    begin
        Application.MessageBox('Preencha o campo do tipo de despesa!', 'Atenção!', MB_ICONWARNING);
        Exit;
    end
...
//CADASTRO
    ...
    begin
        ALTERA_DESPESA.Parameters.ParamByName('@TIPO').Value := 'ÁGUA';
        ALTERA_DESPESA.Parameters.ParamByName('@PRODUTO').Value := NULL;
    end
    ...
    begin
        if Edit3.Text = '' then
        begin
            Application.MessageBox('Selecione um produto na tabela de produtos!', 'Atenção!', MB_ICONWARNING);
            Exit;
        end
        else
        begin
