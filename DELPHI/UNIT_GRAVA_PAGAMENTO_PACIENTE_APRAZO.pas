...
begin
  ...
  begin
    Application.MessageBox('Preencha a data do pagamento!', 'Atenção!',
      MB_ICONWARNING);
    MaskEdit1.SetFocus;
    Exit;
  end;
  ...
  begin
    Application.MessageBox('Selecione o tipo de pagamento!', 'Atenção!',
      MB_ICONWARNING);
    Exit;
  end;
  ...
  begin
    Application.MessageBox(
      'Se o tipo de pagamento for "OUTROS" você deve preencher o campo "OUTROS"!'
  ...
  begin
    Application.MessageBox('Digite o valor do pagamento a vista!', 'Atenção!',
      MB_ICONWARNING);
    Edit1.SetFocus;
    Exit;
  end;
  ...
  begin
    Application.MessageBox('Escolha o status do pagamento!', 'Atenção!',
      MB_ICONWARNING);
  ...
  begin
    GRAVA_PAGAMENTO_APRAZO.Parameters.ParamByName('@TIPO').Value := 'CARTÃO' ;
  end
  ...
  begin
    GRAVA_PAGAMENTO_APRAZO.ExecProc;
        ...
        with GRAVA_LOG do
        begin
          Parameters.ParamByName('@DESCRICAO').Value := 'Pag. à prazo nº ' + INTTOSTR(GRAVA_PAGAMENTO_APRAZO.Parameters.ParamByName('@RETURN_VALUE').Value) + ' cadastrado.' ;
